...
<head>
	...
	<title>新用户注册</title>
<body >
	<form method="POST" action="/HFWeb/Servlet/AcceptUserReg" name="form1" onsubmit="return on_submit()" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/HFWeb/WebContent/Study/Section2/UserReg.jsp">
	新用户注册<br>
