...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-59" data-genuitec-path="/HFWeb/WebContent/Study/Section5/javaBeanJSP2.jsp">
	<form action="javaBeanJSP2.jsp" method="post" name="form1" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-59" data-genuitec-path="/HFWeb/WebContent/Study/Section5/javaBeanJSP2.jsp">
